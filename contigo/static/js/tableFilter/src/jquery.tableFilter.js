    ...
    prototype: {
        ...
        getDataType : function(str) {
            if (!isNaN(Date.parse(str))) {
                return "date";
                } else if (!isNaN(Number(str.replace(/[$ःआ�,~+]?/g, '')))){
                return "number";
                } else {
                return "string";
            };
